import { o as me, t as we } from "../chunks/scheduler.20a43439.js";
import {
  S as Be,
  a as Ge,
  I as M,
  ...
  P as Me,
  e as Xe,
} from "../chunks/singletons.a0da24c0.js";
import { b as J } from "../chunks/paths.8e0103b2.js";

// 这个函数根据配置决定是否在URL结尾添加或移除斜杠，这对于路由匹配和一致性非常重要。
function Ze(t, r) {
  return t === "/" || r === "ignore"
    ? t
    : r === "never"
...
function It(t, r) {
  ...
  function Pe(e) {
    ...
    const n = {
      ...
      to: {
        params: h.params,
        route: {
          id: ((o = h.route) == null ? void 0 : o.id) ?? null,
        },
  ...
  async function X({
    ...
    const b = {
      ...
      props: {
        constructors: Et(n).map((_) => _.node.component),
      },
    };
  ...
  async function ue({
    ...
    if ((y = b.universal) != null && y.load) {
      ...
      const _ = {
        route: new Proxy(a, {
          get: (w, O) => ((v.route = !0), w[O]),
        }),
        params: new Proxy(o, {
          get: (w, O) => (v.params.add(O), w[O]),
        }),
  ...
  function Ye() {
    ...
    u.addEventListener("mousedown", i),
      u.addEventListener("touchstart", i, {
        passive: !0,
      });
